...
final class ProfileViewModel: ObservableObject {
    ...
    func saveProfileImage(item: PhotosPickerItem) {
        ...
        Task {
            ...
            print(path)
            print(name)
            let url = try await StorageManager.shared.getUrlForImage(path: path) // get the url as we save to avoid extra fetch request
    ...
    func deleteProfileImage() {
        ...
        Task {
            try await StorageManager.shared.getUrlForImage(path: path) // get the url as we save to avoid extra fetch request
